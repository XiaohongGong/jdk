...
public class Double128VectorTests extends AbstractVectorTest {
    ...
    static void MULDouble128VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, Double128VectorTests::MUL);
    }
    ...
    static void FIRST_NONZERODouble128VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertArraysEquals(r, a, b, Double128VectorTests::FIRST_NONZERO);
    }
    ...
    static void addDouble128VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(r, a, b, Double128VectorTests::add);
    }
    ...
    static void addDouble128VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(r, a, b, mask, Double128VectorTests::add);
    }
    ...
    static void subDouble128VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(r, a, b, Double128VectorTests::sub);
    }
    ...
    static void subDouble128VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(r, a, b, mask, Double128VectorTests::sub);
    }
    ...
    static void mulDouble128VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(r, a, b, Double128VectorTests::mul);
    }
    ...
    static void ADDDouble128VectorTestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastLongArraysEquals(r, a, b, Double128VectorTests::ADD);
    }
    ...
    static void MINDouble128VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(r, a, b, Double128VectorTests::MIN);
    }
    ...
    static void blendDouble128VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, Double128VectorTests::blend);
    }
    ...
    static void RearrangeDouble128VectorTestsMaskedSmokeTest(IntFunction<double[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(r, a, b, origin, part, mask, Double128VectorTests::unslice);
    }
    ...
    static void FMADouble128VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertBroadcastArraysEquals(r, a, b, c, Double128VectorTests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpProvider")
    static void FMADouble128VectorTestsAltBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void FMADouble128VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, Double128VectorTests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpMaskProvider")
    static void FMADouble128VectorTestsAltBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<double[]> fc, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
    ...
    static void NEGDouble128VectorTests(IntFunction<double[]> fa) {
        ...
        assertArraysEquals(r, a, Double128VectorTests::NEG);
    }
    ...
    static void NEGMaskedDouble128VectorTests(IntFunction<double[]> fa,
        ...
        assertArraysEquals(r, a, mask, Double128VectorTests::NEG);
    }
    ...
    static void ABSDouble128VectorTests(IntFunction<double[]> fa) {
        ...
        assertArraysEquals(r, a, Double128VectorTests::ABS);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ADDReduceLongDouble128VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                Double128VectorTests::ADDReduceLong, Double128VectorTests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ADDReduceLongDouble128VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                Double128VectorTests::ADDReduceLongMasked, Double128VectorTests::ADDReduceAllLongMasked);
    }
    ...
    static void blendDouble128VectorTestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, Double128VectorTests::blend);
    }


    @Test(dataProvider = "doubleUnaryOpSelectFromProvider")
    static void SelectFromDouble128VectorTests(IntFunction<double[]> fa,
