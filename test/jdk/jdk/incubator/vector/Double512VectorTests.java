...
public class Double512VectorTests extends AbstractVectorTest {
    ...
    static void ADDDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void SUBDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void MULDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, mask, Double512VectorTests::MUL);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void FIRST_NONZERODouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, Double512VectorTests::FIRST_NONZERO);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void FIRST_NONZERODouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void addDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastArraysEquals(r, a, b, Double512VectorTests::add);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void addDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, Double512VectorTests::add);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void subDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, Double512VectorTests::sub);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void subDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, mask, Double512VectorTests::sub);
    }

    @Test(dataProvider = "doubleBinaryOpProvider")
    static void mulDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, Double512VectorTests::mul);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void mulDouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void ADDDouble512VectorTestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        ...
        assertBroadcastLongArraysEquals(r, a, b, Double512VectorTests::ADD);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MINDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertBroadcastArraysEquals(r, a, b, Double512VectorTests::MIN);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void MAXDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void IS_DEFAULTDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_NEGATIVEDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_FINITEDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_NANDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleTestOpProvider")
    static void IS_INFINITEDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    static void LTDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void GTDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void EQDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void NEDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void LEDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpMaskProvider")
    static void GEDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void LTDouble512VectorTestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void EQDouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleCompareOpProvider")
    static void EQDouble512VectorTestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
    ...
    static void blendDouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(r, a, b, mask, Double512VectorTests::blend);
    }

    @Test(dataProvider = "doubleUnaryOpShuffleProvider")
    static void RearrangeDouble512VectorTests(IntFunction<double[]> fa,
    ...
    static void RearrangeDouble512VectorTestsMaskedSmokeTest(IntFunction<double[]> fa,
                                                          BiFunction<Integer,Integer,int[]> fs,
                                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        int[] order = fs.apply(a.length, SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void BroadcastDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void sliceBinaryDouble512VectorTestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = new double[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void sliceDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
    IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void unsliceBinaryDouble512VectorTestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = new double[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void unsliceDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
    IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, b, origin, part, mask, Double512VectorTests::unslice);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void SINDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void EXPDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void LOG1PDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void LOGDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void LOG10Double512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void EXPM1Double512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void COSDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void TANDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void SINHDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void COSHDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void TANHDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ASINDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ACOSDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ATANDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void CBRTDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void HYPOTDouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void POWDouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void ATAN2Double512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void FMADouble512VectorTestsBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertBroadcastArraysEquals(r, a, b, c, Double512VectorTests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpProvider")
    static void FMADouble512VectorTestsAltBroadcastSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
    ...
    static void FMADouble512VectorTestsBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastArraysEquals(r, a, b, c, mask, Double512VectorTests::FMA);
    }

    @Test(dataProvider = "doubleTernaryOpMaskProvider")
    static void FMADouble512VectorTestsAltBroadcastMaskedSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<double[]> fc, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] c = fc.apply(SPECIES.length());
    ...
    static void NEGDouble512VectorTests(IntFunction<double[]> fa) {
        ...
        assertArraysEquals(r, a, Double512VectorTests::NEG);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void NEGMaskedDouble512VectorTests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(r, a, mask, Double512VectorTests::NEG);
    }
    ...
    static void ABSDouble512VectorTests(IntFunction<double[]> fa) {
        ...
        assertArraysEquals(r, a, Double512VectorTests::ABS);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ABSMaskedDouble512VectorTests(IntFunction<double[]> fa,
                                                IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void ADDReduceLongDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        ...
        assertReductionLongArraysEquals(r, ra, a,
                Double512VectorTests::ADDReduceLong, Double512VectorTests::ADDReduceAllLong);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void ADDReduceLongDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        long[] r = lfr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionLongArraysEqualsMasked(r, ra, a, mask,
                Double512VectorTests::ADDReduceLongMasked, Double512VectorTests::ADDReduceAllLongMasked);
    }
    ...
    static void blendDouble512VectorTestsBroadcastLongSmokeTest(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertBroadcastLongArraysEquals(r, a, b, mask, Double512VectorTests::blend);
    }


    @Test(dataProvider = "doubleUnaryOpSelectFromProvider")
    static void SelectFromDouble512VectorTests(IntFunction<double[]> fa,
